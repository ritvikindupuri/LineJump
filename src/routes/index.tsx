    ...
    <header className="sticky top-0 z-30 border-b border-border/30 bg-background/60 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-5">
          <Link
            to="/app"
            className="inline-flex items-center justify-center rounded-full bg-foreground px-4 py-1.5 text-[13px] font-medium tracking-tight text-background transition-all hover:opacity-90"
          >
            Launch Dashboard
          </Link>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-6 pb-12 pt-20 sm:pt-28">
        ...
        >
          ...
          <motion.div {...fadeUp} className="mt-10 flex items-center justify-center gap-3">
            <Link
              to="/app"
              className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-[14px] font-medium tracking-tight text-primary-foreground transition-all hover:opacity-90"
            >
              Launch Dashboard
